...
const User = () => {
  ...
  useEffect(() =>{
     ...
     const getUserData=async()=>{
      ...
      const userReposData=await getRepos(params.login)
      dispatch({type: 'GET_REPOS', payload:userReposData})
     }
     getUserData()
  }, [dispatch, params.login])

  //desctructure from user object
  const {
    name, 
    type,
    avatar_url,
              ...
              <div className="cols-span-2">
                <div className="mb-6">
                  ...
                  <div className="mt-4 card-actions">
                    <a href={html_url}  target='_blank' rel='nonreferrer' className='btn btn-outline'>Visit Github Profile</a>
                  </div>
                </div>
